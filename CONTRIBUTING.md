...
Thank you for your interest in contributing to toolpaths.

## Current status

> [!NOTE]
> toolpaths is in early development and is not yet accepting pull requests.
...
- **Report bugs** - If you encounter issues while using toolpaths, please open a GitHub issue with a minimal reproducible example
- **Request features** - Have an idea that would make toolpaths more useful? Open an issue to start a discussion
- **Improve documentation** - Found a typo or unclear explanation? Documentation improvements are welcome
- **Share feedback** - Open an issue or discussion about how you're using toolpaths and what could be better
