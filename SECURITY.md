...
tooldirs is currently in early development. Security updates apply to the latest version only.
...
tooldirs supports Go 1.23+.

## Reporting a vulnerability

If you discover a security vulnerability in tooldirs, please report it responsibly.
...
1. Go to the [Security tab](https://github.com/tbhb/tooldirs/security) of the repository
